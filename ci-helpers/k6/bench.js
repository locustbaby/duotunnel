...
export function handleSummary(data) {
  ...
  const phases = [
    ...
    {name:'Ingress 3K', start:70, end:90, scenarios:['ingress_3000qps']},
    {name:'Egress 3K', start:95, end:115, scenarios:['egress_3000qps']},
    {name:'Ingress no-KL', start:120, end:140, scenarios:['ingress_3000qps_nokl']},
    {name:'Egress no-KL', start:145, end:165, scenarios:['egress_3000qps_nokl']},
  ];
