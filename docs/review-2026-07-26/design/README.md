...
>
> **工作模式更新**：D1–D7 仍是实施前蓝图；D9 的 M0 与 D10 的 P0 共同项已于
> 2026-07-27 落地，具体状态以各文档顶部实施记录为准。
>
> ## 📌 当前状态：D9/M0 与 D10/P0 代码已实施；rollout 验收及其余设计仍待排期
>
> D1–D10 均已完成设计并记录在此。D9/M0 与 D10/P0 已进入实现并完成本地门禁；
> D9 中未勾选的跨版本、并发、故障注入与长稳验收，以及 D1–D7、D10 的 P1/P2
> 尚未排期。2026-07-27 第三轮复核新增 D9/D10，并把
> D7（Phase B 多 Endpoint）从
...
> delivery、listener/slot ownership、readiness/drain 等新阻断项。它们已统一在
> **D9/M0** 收口；D1–D7 现在可从 M1 可信基线之后重新排期。同时提示两点漂移风险：
