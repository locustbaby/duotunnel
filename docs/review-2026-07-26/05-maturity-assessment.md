...
| **抽象/组合** | **3.5** | 强：UpstreamResolver/PeerSpec/IngressProtocolHandler trait 边界清晰，静态分发。短：H1 body 的 oneshot-reclaim 是缺 Session 抽象的症状、tunnel-lib 过大 | TODO-77（oneshot-reclaim / 缺 Session）、TODO-83（tunnel-lib 过大） |
...
**M3 靠后**：M3 动核心抽象（Session 统一、tunnel-lib 拆分），必须站在 M1 的测试网
