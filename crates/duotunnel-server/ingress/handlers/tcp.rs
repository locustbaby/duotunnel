...
async fn handle_tcp_connection(
    ...
    let runtime = duotunnel_core::SniffRuntime::new(
        duotunnel_core::SniffPolicy::default(),
        duotunnel_core::default_ingress_detectors(),
    );
    let sniffed =
    ...
    let protocol = if sniffed.bytes_read == 0 {
        duotunnel_core::proxy::core::Protocol::Unknown
    } else {
