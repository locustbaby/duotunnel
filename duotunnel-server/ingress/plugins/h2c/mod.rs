...
use duotunnel_lib::transport::listener::RouteTarget;
use duotunnel_lib::{EmptyBodyRetryTemplate, OpenStreamRequest, ProxyError};
...
struct CachedSender {
    ...
    sender: duotunnel_lib::H2Sender,
}

fn error_response(err: &ProxyError) -> Response<duotunnel_lib::proxy::h2_proxy::BoxBody> {
...
fn observe_h2c_error(metrics: &Arc<dyn duotunnel_lib::plugin::MetricsSink>, err: &ProxyError) {
    duotunnel_lib::plugin::observe_proxy_error(metrics.as_ref(), ProtocolKind::H2c.as_label(), err);
    metrics.incr(
...
fn get_or_create_sender(
    ...
    let entry = CachedSender {
        selected,
        sender: duotunnel_lib::new_h2_sender(),
    };
...
impl IngressProtocolHandler for H2cHandler {
    ...
    async fn handle(
        ...
        let service = service_fn(move |req: Request<hyper::body::Incoming>| {
            ...
            async move {
                ...
                let routing_info = duotunnel_lib::RoutingInfo {
                    ...
                    src_addr,
                    src_port,
                    protocol: duotunnel_lib::proxy::core::Protocol::H2,
                    host: Some(host),
                };
                ...
                match duotunnel_lib::forward_h2_request(
        ...
        let connection = duotunnel_lib::proxy::h2::hardened_h2_server_builder(
